...
This project applies Linear Regression to predict housing prices using the Boston Housing dataset. The workflow includes data cleaning, feature engineering, scaling, model training, evaluation, and interpretability analysis.
...
👉 Indicates good generalization with slight overfitting.
